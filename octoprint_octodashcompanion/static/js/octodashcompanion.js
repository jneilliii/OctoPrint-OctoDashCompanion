/*
 * View model for OctoDash Companion
 *
 * Author: jneilliii
 * License: MIT
 */
$(function() {
    function OctodashcompanionViewModel(parameters) {
        var self = this;
        ...
        self.octodash_icons = [
        {
            ...
            title: "grin-tongue-squint",
            searchTerms: [ "LOL", "emoticon", "face" ]
        }, {
            title: "grin-tongue-wink",
            searchTerms: [ "LOL", "emoticon", "face" ]
        }, {
            title: "grin-wink",
            ...
            title: "microphone-alt",
            searchTerms: [ "audio", "podcast", "record", "sing", "sound", "voice" ]
        }, {
            title: "microphone-alt-slash",
            ...
            title: "money-bill-alt",
            searchTerms: [ "buy", "cash", "checkout", "money", "payment", "price", "purchase" ]
        }, {
            title: "money-bill-wave",
            searchTerms: [ "buy", "cash", "checkout", "money", "payment", "price", "purchase" ]
        }, {
            title: "money-bill-wave-alt",
            searchTerms: [ "buy", "cash", "checkout", "money", "payment", "price", "purchase" ]
        }, {
            title: "money-check",
    ...
    OCTOPRINT_VIEWMODELS.push({
        construct: OctodashcompanionViewModel,
        // ViewModels your plugin depends on, e.g. loginStateViewModel, settingsViewModel, ...
        dependencies: ["settingsViewModel"],
        // Elements to bind to, e.g. #settings_plugin_octodashcompanion, #tab_plugin_octodashcompanion, ...
        elements: [ "#settings_plugin_octodashcompanion" ]
    });
});
